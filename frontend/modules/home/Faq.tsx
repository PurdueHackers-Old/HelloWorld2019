		...
		<div className="uk-container fullwidth uk-flex uk-flex-between uk-flex-wrap">
			...
			<div className="uk-padding-small uk-width-1-3@m">
				<div className="uk-card uk-card-default uk-card-body fullheight">
					...
					<p>
						Just sign up
						<a href="/#/register">here!</a> with your Purdue email and fill out the
			...
			<div className="uk-padding-small uk-width-1-3@m">
				<div className="uk-card uk-card-default uk-card-body fullheight">
					...
					<p>
						No problem! You can email us at
