...
// Action Types
type SetToken = { type: typeof AUTH_TOKEN_SET; token: string };
type SetUser = { type: typeof AUTH_USER_SET; user: IUser };

type SetGreenFlash = { type: typeof FLASH_GREEN_SET; green: string };
type SetRedFlash = { type: typeof FLASH_RED_SET; red: string };
